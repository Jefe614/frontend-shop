...
const PerformancePage = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h1 className="text-3xl font-bold mb-6 text-center text-gray-800 animate__animated animate__fadeIn">Performance Summary</h1>
            {error && <div className="text-red-500 mb-4 text-center animate__animated animate__fadeIn animate__delay-1s">{error}</div>}

            {/* Shop Data Table */}
            <div className="overflow-x-auto mb-8">
                <table className="min-w-full bg-white shadow-md rounded-lg border border-gray-200 animate__animated animate__fadeIn animate__delay-1s">
                    ...
                    <tbody>
                        {shopData.map((data, index) => (
                            <tr key={index} className="bg-white border-b hover:bg-gray-100 transition-all duration-300 ease-in-out">
            ...
            {/* KPIs Section */}
            <div className="mt-12">
                <h2 className="text-3xl font-bold mb-8 text-center text-gray-800 animate__animated animate__fadeIn">Key Performance Indicators (KPIs)</h2>
                <div className="flex flex-wrap justify-center gap-8">
                    {shopData.map((data, index) => (
                        <div
                            key={index}
                            className="max-w-sm w-full bg-white border-2 border-blue-600 rounded-lg p-6 shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl animate__animated animate__fadeIn animate__delay-1s"
                        >
            ...
            <div className="mt-8">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md animate__animated animate__fadeIn animate__delay-1s">
            ...
            {/* Alerts Section */}
            {alerts.length > 0 && (
                <div className="mt-8 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg animate__animated animate__fadeIn animate__delay-1s">
